...
//var nn = new NeuralNetwork(NUMBER_OF_INPUTS, .00001, new CategoricalCrossEntropyLossFunction());
...
nn.AddLayer(new DenseLayer(6, new SignActivationFunction()));
nn.AddLayer(new DenseLayer(1, new SignActivationFunction()));

nn.Train(200, inputs, outputs, 2, true);
